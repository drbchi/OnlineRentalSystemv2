function getRoomTitleFromURL() {
    ...
    return params.get('roomTitle') || '';
}

const roomTitle = getRoomTitleFromURL();
const roomTitleHidden = document.getElementById('roomTitleHidden');
if (roomTitleHidden) {
    roomTitleHidden.value = roomTitle;
}
...
if (roomTypeSelect) {
    ...
    roomTitle: document.getElementById('roomTitleHidden').value  // <-- Add this line
};
    ...
    function handleSuccess(result) {
        ...
        const roomTitle = document.getElementById('roomTitleHidden').value || 'a room';
const notification = {
    message: `${fullName} booked ${roomTitle}.`,
    seen: false
};
